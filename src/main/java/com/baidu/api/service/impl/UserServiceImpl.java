...
public class UserServiceImpl extends BaseService implements IUserService {
    ...
    private final static String USER_GETLOGGEDUSER_PATH = "passport/users/getLoggedInUser";

    private final static String USER_GETINFO_PATH = "passport/users/getInfo";

    private final static String USER_ISAPPUSER_PATH = "passport/users/isAppUser";

    private final static String USER_HASAPPPERMISSION_PATH = "passport/users/hasAppPermission";

    private final static String USER_HASAPPPERMISSIONS_PATH = "passport/users/hasAppPermissions";

    @Override
    public User getLoggedInUser() throws BaiduApiException {
        String apiPath = USER_GETLOGGEDUSER_PATH;
        String jsonResult = "";
        jsonResult = makeApiCall(apiPath, BaiduApiClient.REST, null, BaiduApiClient.METHOD_GET);
    ...
    public String getInfo(long uid, String[] fields) throws BaiduApiException {
        ...
        String jsonResult = "";
        jsonResult = makeApiCall(apiPath, BaiduApiClient.REST, params, BaiduApiClient.METHOD_GET);
        return jsonResult;
    }
